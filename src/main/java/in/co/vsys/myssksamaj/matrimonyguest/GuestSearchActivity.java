...
public class GuestSearchActivity extends AppCompatActivity implements DisplaySelectedValue, AllOccupationContract.AllOccupationView, AllAnnualIncomeContract.AllAnnualIncomeView {

    private static final String TAG = GuestSearchActivity.class.getSimpleName();
    private static final String STATE_ID = "StateId";
    private static final String COUNTRY_STATE_ID = "CountryID";
    private ProgressBar mProgressBar;
    private AppCompatRadioButton radio_male, radio_female;
    ...
    private String S_minHeight = "", S_maxHeight = "", S_minAge = "", S_maxAge = "", S_countryId = "", S_eductionIn = "", S_annualIncome,
            S_stateId = "", S_cityId = "";
    ...
    private AppCompatButton btn_search, btn_filter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPreferences.edit().remove("S_manglik").apply();
        mPreferences.edit().remove("S_physicaldisablity").apply();
        mPreferences.edit().remove("S_income").apply();
        mPreferences.edit().remove("S_occupation").apply();
        ...
        btn_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (uniqueId.length() > 3) {
                    ...
                    Intent intent = new Intent(GuestSearchActivity.this, GuestSearchDisplayActivity.class);
                    ...
                    Toast.makeText(GuestSearchActivity.this, "Invalid Id...", Toast.LENGTH_SHORT).show();
                }
        ...
        btn_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(radio_yesManglik.isChecked()){
                    manglik="Yes";
                }if(radio_noManglik.isChecked()){
                    manglik="No";
                }

                Log.d(TAG, "onClick: "+" "+strPhisicalDisablity+" "+strIncome+" "+strOccupation+" "+manglik);


                Intent intent = new Intent(GuestSearchActivity.this, GuestSearchListActivity.class);
                ...
                Log.d(TAG, "onClick: " + S_marriedStatus);
                mPreferences.edit().putString("S_countryId", S_countryId).apply();
                mPreferences.edit().putString("S_stateId", S_stateId).apply();
                mPreferences.edit().putString("S_cityId", S_cityId).apply();
                mPreferences.edit().putString("S_gender", S_Gendor).apply();

                mPreferences.edit().putString("S_manglik", manglik).apply();
                mPreferences.edit().putString("S_physicaldisablity", strPhisicalDisablity).apply();
                mPreferences.edit().putString("S_income", strIncome).apply();
                mPreferences.edit().putString("S_occupation", strOccupation).apply();
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                Toast.makeText(GuestSearchActivity.this, "Country not available", Toast.LENGTH_SHORT).show();
                            }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                Toast.makeText(GuestSearchActivity.this, "State not available", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
    ...
    private void CountryPop() {
        ...
        AlertDialog.Builder aBuilder = new AlertDialog.Builder(GuestSearchActivity.this);
        ...
        final MTPopAdapter adapter = new MTPopAdapter(GuestSearchActivity.this, countryList, GuestSearchActivity.this);
    ...
    private void StatePOp() {
        ...
        final MTPopAdapter adapter = new MTPopAdapter(GuestSearchActivity.this, stateList, GuestSearchActivity.this);
        stateList.remove(0);
        mListView.setAdapter(adapter);
    ...
    private void CityPOp() {
        ...
        final MTPopAdapter adapter = new MTPopAdapter(GuestSearchActivity.this, cityList, GuestSearchActivity.this);
        cityList.remove(0);
        mListView.setAdapter(adapter);
        aBuilder.setPositiveButton("Done", null);
        aBuilder.setNegativeButton("Cancel", null);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                Toast.makeText(GuestSearchActivity.this, "MotherList not available", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
    ...
    private void motherTouguePOp() {
        ...
        final MTPopAdapter adapter = new MTPopAdapter(GuestSearchActivity.this, motherTougueLIst, GuestSearchActivity.this);
   ...
   /* private void StatePOp() {
    ...
    private void marriedStatus() {
        ...
        final MTPopAdapter adapter = new MTPopAdapter(GuestSearchActivity.this, marriedList, GuestSearchActivity.this);
        //  cityList.remove(0);
        mListView.setAdapter(adapter);
        aBuilder.setPositiveButton("Done", null);
        aBuilder.setNegativeButton("Cancel", null);
   ...
   /* private void CountryPop() {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                startActivity(new Intent(GuestSearchActivity.this, LoginOptionsActivity.class));
                finish();
    ...
    public void showAnnualIncome(final List<AllAnnualIncomeModel> annualIncomeList) {
        ...
        CustomSpinnerAdapter spnIncomeAdapter = new CustomSpinnerAdapter(this, annualIncomeList, R.layout.row_search_spinner, new CustomSpinnerAdapter.ItemClickedListener() {
            @Override
    ...
    public void showAllOccuption(final List<OccupationModel> occupationList) {
        ...
        CustomSpinnerAdapter spnOccupationAdapter = new CustomSpinnerAdapter(this, occupationList, R.layout.row_search_spinner, new CustomSpinnerAdapter.ItemClickedListener() {
            @Override
            public void onViewBound(View view, Object object, int position) {
