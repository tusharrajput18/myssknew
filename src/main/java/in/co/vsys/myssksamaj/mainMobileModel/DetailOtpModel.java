...
public class DetailOtpModel {
    ...
    @SerializedName("ismycaste")
    @Expose
    private String ismycaste;
    ...
    public String getIsmycaste() {
        return ismycaste;
    }

    public void setIsmycaste(String ismycaste) {
        this.ismycaste = ismycaste;
    }
