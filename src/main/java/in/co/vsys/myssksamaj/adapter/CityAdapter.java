...
public class CityAdapter extends BaseAdapter implements Filterable {
    ...
    private List<CityModel> filterList;
    private LayoutInflater inflater = null;


    public CityAdapter(@NonNull Context context, @NonNull List<CityModel> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        CityModel item = this.filterList.get(position);
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                filterList = (List<CityModel>) results.values;
