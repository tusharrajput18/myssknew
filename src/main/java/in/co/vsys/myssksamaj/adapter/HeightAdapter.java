...
public class HeightAdapter extends BaseAdapter implements Filterable {
    ...
    public HeightAdapter(@NonNull Context context, @NonNull List<DrawerItem> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        itemHolder.tv_title.setText(item.getHeight());
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (DrawerItem item : list) {
                        ...
                        if (item.getHeight().toLowerCase().contains(charString)) {
