...
import in.co.vsys.myssksamaj.activities.ProfileVisitorListActivity;
 ...
 */
public class PVisitorVPagerAdapter extends PagerAdapter implements DownloadProfileContract.DownloadProfileView, GetPdfUrlContract.GetPdfUrlView {

    private Context mContext;
    private List<RecentlyProfileVisitorModel> list;
    private LayoutInflater inflater;
    private String memberName, memberOther, imageUrl;
    ...
    public PVisitorVPagerAdapter(Context mContext, List<RecentlyProfileVisitorModel> list) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        MatrimonyUtils.sendMemberIdTask(memberId, recentlyProfileVisitorModel.getUserMemberId());
        ...
        MatrimonyUtils.sendProfileViewNotification(recentlyProfileVisitorModel.getTokenId(), message,
                imageUrl, String.valueOf(recentlyProfileVisitorModel.getUserMemberId()), String.valueOf(memberId), name);
        ...
        if (recentlyProfileVisitorModel.getOnlinestatus().equalsIgnoreCase("online")) {
        ...
        if (recentlyProfileVisitorModel.getProfileCreatedBy().equals("P")) {
            ...
            download.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    fileName=recentlyProfileVisitorModel.getFirstName()+"_"+recentlyProfileVisitorModel.getLastName();

                    getPdfUrlPresenter.getProfilePdf(String.valueOf(recentlyProfileVisitorModel.getUserMemberId()));
...
//        tvSubCaste.setText("" + recentlyProfileVisitorModel.getSubCaste());
        ...
        Log.e("url::" + position, recentlyProfileVisitorModel.getUserProfileUrl());
    ...
    public void showError(final String message) {
        ...
        ((ProfileVisitorViewActivity)mContext).runOnUiThread(new Runnable() {
            @Override
            public void run() {
